...
def get_act_refugee_resources():
    resources = [
        ...
        Resource(
            ...
            contact=ContactInfo(phone="000", website="https://www.triplezero.gov.au", hours="24/7"),
            ...
            languages_available=[
                "English",
                "Interpreter services available - say 'police', 'fire', or 'ambulance' first",
            ],
            cost="Free",
        ...
        Resource(
            ...
            contact=ContactInfo(phone="(02) 6280 0900", website="https://dvcs.org.au", hours="24/7"),
        ...
        Resource(
            ...
            contact=ContactInfo(
                phone="(02) 6205 9000", website="https://www.library.act.gov.au", hours="Varies by branch"
            ),
        ...
        Resource(
            ...
            subcategory="NDIS",
            contact=ContactInfo(phone="1800 800 110", website="https://www.ndis.gov.au", hours="Mon-Fri 8am-8pm"),
